...
def webhook():
    ...
    p = subprocess.run("git pull && echo yes_and_npm_i > /home/uidd2021/users/andythebreaker/chmod777/server_ctrl/restart_mode", shell=True,cwd=Path(__file__).parent.absolute())
    return ""
